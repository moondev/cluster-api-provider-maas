...
require github.com/spectrocloud/cluster-api-provider-maas v1.9.4
...
// replace github.com/spectrocloud/maas-client-go => ./pkg/maas/maasclient
// replace github.com/canonical/gomaasclient => ./pkg/maas/maasclient
