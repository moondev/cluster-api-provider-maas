...
func TestMachine(t *testing.T) {
	...
	t.Run("get machine with fqdn", func(t *testing.T) {
		...
		g.Expect(machine.Addresses).To(ContainElements(v1beta2.MachineAddress{
			Type:    v1beta2.MachineExternalDNS,
			Address: "abc123.domain.local",
		}, v1beta2.MachineAddress{
			Type:    v1beta2.MachineExternalIP,
			Address: "1.2.3.4",
		}))
	})
